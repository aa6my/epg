::modified from DateAdd (https://www.robvanderwoude.com/sourcecode.php?src=dateadd_nt)
::Install sed before running! (https://sourceforge.net/projects/gnuwin32/files//sed/4.2.1/sed-4.2.1-setup.exe/download)
@ECHO OFF
ECHO.
